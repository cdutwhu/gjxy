...
func TestJSONMake(t *testing.T) {
	...
	JSONBuildIPath(mIPathObj, "ROOT", "StaffPersonal", "ROOT.StaffPersonal#1", true)
	JSONBuildIPath(mIPathObj, "ROOT", "StaffPersonal", "ROOT.StaffPersonal#2", true)
	JSONBuildIPath(mIPathObj, "ROOT", "NAME", "HELLO ROOT", true)
	JSONBuildIPath(mIPathObj, "ROOT", "GNAME", "HELLO", false)
	JSONBuildIPath(mIPathObj, "ROOT", "GNAME", "WORLD 1", false)
	JSONBuildIPath(mIPathObj, "ROOT", "GNAME", "WORLD 2", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1", "name", "hello world", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1", "fname", "world", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1", "gname", "hello", false)	
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2", "NAME", "HELLO WORLD", true)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2", "FNAME", "WORLD", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2", "GNAME", "HELLO", false)

	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "sub name", "hello sub world", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "sub fname", "sub world", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1", "test", "ROOT.StaffPersonal#1.SubTest", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "sub gname", "sub hello", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB NAME", "HELLO SUB WORLD A", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB NAME", "HELLO SUB WORLD B", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB NAME", "HELLO SUB WORLD C", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB NAME", "HELLO SUB WORLD D", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "SUB NAME", "HELLO SUB WORLD 1", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "SUB NAME", "HELLO SUB WORLD 2", false)
	JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#1.SubTest", "SUB NAME", "HELLO SUB WORLD 3", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB FNAME", "SUB WORLD", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2", "test", "ROOT.StaffPersonal#2.SubTest", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB GNAME", "SUB HELLO", false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB GNAME 1", true, false)
	// JSONBuildIPath(mIPathObj, "ROOT.StaffPersonal#2.SubTest", "SUB GNAME 1", false, false)
